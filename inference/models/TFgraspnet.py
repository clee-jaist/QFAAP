...
"""
TF-Grasp, RA-L Paper (https://ieeexplore.ieee.org/abstract/document/9810182)
"""
...
class PatchEmbed(nn.Module):
    ...
    def forward(self, x):
        ...
        #                   0, 0))
        x = self.proj(x).flatten(2).transpose(1, 2)  # B Ph*Pw
...
class SwinTransformerSys(nn.Module):
    ...
    """
    TF-Grasp, RA-L 2022 (https://doi.org/10.1109/LRA.2022.3187261)
    """
