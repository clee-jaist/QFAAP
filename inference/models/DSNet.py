...
from inference.models.dsnet.TransUNet_Part import PatchMerging, PatchExpand, FinalPatchExpand_X4, BasicLayer, BasicLayer_up, \
    PatchEmbed
from inference.models.dsnet.MobileUNet_Part import InvertedResidualBlock
from inference.models.dsnet.Bridge_Part import MtoT, TtoM


class DSNetSys(nn.Module):

    """
    DSNet, RA-L 2024 (https://doi.org/10.1109/LRA.2024.3381091)
    """
