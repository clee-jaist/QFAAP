...
class GraspRectangle:
    ...
    def plot(self, ax, color=None):
        ...
        ax.plot(points[:, 1], points[:, 0], color=color,  linewidth=1)
...
def detect_grasps(q_img, ang_img, width_img=None, no_grasps=1,point=None):
    """
