...
class CornellDataset(GraspDatasetBase):
    ...
    def __init__(self, file_path, ds_rotate=0, val=None, **kwargs):
        """
    ...
    def _get_crop_attrs(self, idx):
        ...
        # compute mean center of all label
        center = gtbbs.center
    ...
    def get_depth(self, idx, rot=0, zoom=1.0):
        ...
        # conduct different crop based on if there is val parameters
        if self.val is not None and idx in self.val:
            left = (640 - self.output_size) // 2
            top = (480 - self.output_size) // 2
            right = (640 + self.output_size) // 2
            bottom = (480 + self.output_size) // 2
